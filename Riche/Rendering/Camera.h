...
class Camera {
 ...
 public:
  ...
  glm::vec2 MousePos() const { return m_currentMousePos; }

  glm::vec3 Position() const { return m_Position; }
  glm::vec3 Up() const { return m_UpVector; }
  glm::vec3 Right() const { return m_RightVector; }
  glm::vec3 Forward() const { return m_LookVector; }

  float Near() const { return m_NearPlane; }
  float Far() const { return m_FarPlane; }
